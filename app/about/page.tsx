export default function AboutPage() {
  return (
    <div className="p-8 text-center">
      <h2 className="text-3xl font-bold text-gold mb-4">About the Temple</h2>
      <p className="text-gray-200 max-w-3xl mx-auto">
        The Sri Ayyappa Swamy Temple is being constructed with the blessings of devotees and aims to be a
